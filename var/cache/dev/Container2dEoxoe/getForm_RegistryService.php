...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\AjoutUserType' => function () {
    return ($this->privates['App\Form\AjoutUserType'] ?? $this->privates['App\Form\AjoutUserType'] = new \App\Form\AjoutUserType());
}, 'App\\Form\\EditLiensType' => function () {
    return ($this->privates['App\Form\EditLiensType'] ?? $this->privates['App\Form\EditLiensType'] = new \App\Form\EditLiensType());
}, 'App\\Form\\LiensType' => function () {
    return ($this->privates['App\Form\LiensType'] ?? $this->privates['App\Form\LiensType'] = new \App\Form\LiensType());
}, 'App\\Form\\ModifUserType' => function () {
    return ($this->privates['App\Form\ModifUserType'] ?? $this->privates['App\Form\ModifUserType'] = new \App\Form\ModifUserType());
