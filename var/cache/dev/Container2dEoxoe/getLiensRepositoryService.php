...
// Returns the private 'App\Repository\LiensRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LiensRepository.php';

return $this->privates['App\Repository\LiensRepository'] = new \App\Repository\LiensRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
