...
include_once $this->targetDirs[3].'/src/DataFixtures/Liens.php';
...
$a->addFixtures(array(0 => new \App\DataFixtures\AppFixtures(), 1 => new \App\DataFixtures\Liens(), 2 => new \App\DataFixtures\Userfixture(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php')))));
